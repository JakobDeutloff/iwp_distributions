...
# %% load dardar
dardar_raw = xr.open_dataset("/work/bu1562/m301049/dardar/dardar_iwp_2008.nc")
mask = (dardar_raw["latitude"] > -20) & (dardar_raw["latitude"] < 20)
dardar_raw = dardar_raw.where(mask)

# %% load ccic
ds = xr.open_mfdataset("/work/bu1562/m301049/ccic/*.zarr", engine="zarr")
...
hists["ccic"], edges = np.histogram(ds.values, bins=bins, density=False)
