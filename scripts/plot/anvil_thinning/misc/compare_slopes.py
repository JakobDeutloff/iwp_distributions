...
# %% load slopes
with open("/work/bu1562/m301049/iwp_dists/slopes_monthly.pkl", "rb") as f:
    slopes_monthly = pickle.load(f)
with open("/work/bu1562/m301049/iwp_dists/error_monthly.pkl", "rb") as f:
    error_montly = pickle.load(f)
with open("/work/bu1562/m301049/iwp_dists/slopes_annual.pkl", "rb") as f:
    slopes_annual = pickle.load(f)
with open("/work/bu1562/m301049/iwp_dists/error_annual.pkl", "rb") as f:
    error_annual = pickle.load(f)
with open("/work/bu1562/m301049/iwp_dists/slopes_season.pkl", "rb") as f:
    slopes_season = pickle.load(f)
with open("/work/bu1562/m301049/iwp_dists/error_season.pkl", "rb") as f:
...
fig, axes = plt.subplots(
    4, 3, figsize=(10, 10), sharey="col", sharex="col", width_ratios=[3, 3, 1]
)
