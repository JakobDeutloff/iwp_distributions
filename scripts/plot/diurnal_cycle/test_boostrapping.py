...
ax.plot(n_iterations, mean_feedback, marker='o', color='k')
ax.fill_between(n_iterations, mean_feedback - std_feedback, mean_feedback + std_feedback, alpha=0.3, color='gray')
ax.set_xscale('log')
...
fig.tight_layout()
fig.savefig("plots/diurnal_cycle/ccic_bootstrap_size_test.png")
