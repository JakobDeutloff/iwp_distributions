...
# %%
rlut = xr.open_dataarray("/work/bu1562/m301049/iwp_dists/publication/fluxes/rlut_cs.nc")
...
fig.savefig(
    "plots/diurnal_cycle/publication/diurnal_cycle_radiation.pdf", bbox_inches="tight"
)
