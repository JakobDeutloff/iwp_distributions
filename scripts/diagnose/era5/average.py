...
datasets = {
    ...
    "rad": xr.open_dataarray(
        f"{path}/rad_tendency.nc", chunks={}, decode_timedelta=False
    ),
    "stability": xr.open_dataarray(
        f"{path}/stability.nc", chunks={}, decode_timedelta=False
    ),
    "subsidence": xr.open_dataarray(
        f"{path}/subsidence.nc", chunks={}, decode_timedelta=False
    ),
    "convergence": xr.open_dataarray(
        f"{path}/convergence.nc", chunks={}, decode_timedelta=False
    ),
}
